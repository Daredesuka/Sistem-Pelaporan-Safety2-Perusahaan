...
<head>
    ...
    <meta charset="utf-8" />
    <title>Register | Company Report Safety</title>
                            ...
                            <div class="row">
                                <div class="col-7">
                                    <div class="text-primary p-4">
                                        ...
                                        <p>Register to proceed to the Company Report Safety application.</p>
                                    </div>
                                </div>
                            ...
                            <div class="p-2">
                                <form class="form-horizontal" action="{{url('user/register/save')}}" method="POST"
                                    ...
                                    <div class="mt-4 text-center">
                                        ...
                                        <br>
                                        <p>Already have an account ? <a href="{{url('user/login')}}"
